<script setup>
useHead({
    title: 'MetaVerso - editor - Noticias',
})
        ...
        <div class="bg-white p-2 rounded-lg flex justify-between">
            ...
            <div class="flex justify-end">
                <NuxtLink to="/editor/novo">
                    <button type="button" class="text-white bg-orange-500 hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-orange-400 font-medium rounded-lg text-sm px-4 py-1.5 text-center">Cadastrar Projeto</button>
                </NuxtLink>
            </div>
        </div>
                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                        ...
                        <tbody>
                            <tr class="odd:bg-white even:bg-gray-200 border-b">
                                ...
                                <td class="px-6 py-4">
                                    <select id="countries" disabled class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500">
